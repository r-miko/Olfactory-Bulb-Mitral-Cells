# File which plots the PGC analysis

import matplotlib.pyplot as plt
import numpy as np

# LOAD ANALYSIS
y = np.load("feature_data_PGC.npy")
...
for i in range(4):
	...
	# Save
	plt.savefig("Figures/PGC_latencies_circuit_"+str(i+1)+".eps",dpi=600)
	plt.savefig("Figures/PGC_latencies_circuit_"+str(i+1)+".png",dpi=300) 
...
for i in range(4):
	...
	# Save
	plt.savefig("Figures/PGC_firing_rate_circuit_"+str(i+1)+".eps",dpi=600)
	plt.savefig("Figures/PGC_firing_rate_circuit_"+str(i+1)+".png",dpi=300) 
...
for i in range(4):
	...
	# Save
	plt.savefig("Figures/PGC_mibfrequencies_circuit_"+str(i+1)+".eps",dpi=600)
	plt.savefig("Figures/PGC_mibfrequencies_circuit_"+str(i+1)+".png",dpi=300) 
