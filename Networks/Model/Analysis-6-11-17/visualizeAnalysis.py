...
for i in range(4):
	...
	ax.plot(x, latencies_mc_315[i,:], '-*',color=(0.1,0.2,0.5,i*0.1+0.4),linewidth=2.0,label='Circuit'+str(i+1))
	ax.plot(x, latencies_mc_54[i,:],'-*',color=(0.5,0.2,0.1,i*0.1+0.4),linewidth=2.0,label='Circuit'+str(i+1))
plt.xlim((0 ,41))
...
# Save
if savefig:
	plt.savefig("MC_latencies.eps",dpi=600)
	#plt.savefig("MC_latencies.png",dpi=300) 
...
for i in range(4):
	...
	ax.plot(x, firing_rate_mc_315[i,:], '-*',color=(0.1,0.2,0.5,i*0.1+0.4),linewidth=2.0,label='Circuit'+str(i+1))
	ax.plot(x, firing_rate_mc_54[i,:],'-*',color=(0.5,0.2,0.1,i*0.1+0.4),linewidth=2.0,label='Circuit'+str(i+1))
plt.xlim((0 ,41))
...
# Save
if savefig:
	plt.savefig("MC_firing_rate.eps",dpi=600)
	#plt.savefig("MC_firing_rate.png",dpi=300) 
